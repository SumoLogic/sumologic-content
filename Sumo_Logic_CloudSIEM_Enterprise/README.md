# Sumo Logic for Cloud SIEM Enterprise (CSE) Content
Sumo Logic Community Content for Cloud SIEM Enterprise (CSE) tooling that is not published to the [App Catalog](https://help.sumologic.com/docs/integrations/).

Here you can find vendor based content (parsers, log mappings, and rules), and Apps for CSE tooling.
