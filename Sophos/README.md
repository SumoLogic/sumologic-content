# Sumo Logic for Sophos
Sumo Logic Community Content built for Sophos that is not published to the [App Catalog](https://help.sumologic.com/docs/integrations/).
