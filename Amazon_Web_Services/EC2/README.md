# Sumo Logic for AWS EC2
Sumo Logic Community Content built for AWS EC2 that is not published to the [App Catalog](https://help.sumologic.com/docs/integrations/).
