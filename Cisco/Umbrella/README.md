# Sumo Logic for Cisco Umbrella
Sumo Logic Community Content built for Cisco Umbrella that is not published to the [App Catalog](https://help.sumologic.com/docs/integrations/).
